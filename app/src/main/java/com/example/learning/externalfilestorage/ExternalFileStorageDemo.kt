package com.example.learning.externalfilestorage
...
class ExternalFileStorageDemo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_external_file_storage_demo)
