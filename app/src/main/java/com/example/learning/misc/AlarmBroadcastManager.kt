...
class AlarmBroadcastManager : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_alarm_broadcast_manager)
        ...
        start.setOnClickListener {
            ...
            Toast.makeText(this, "Alarm will go off in $i seconds", Toast.LENGTH_LONG).show()
        }
...
class AlarmManagerBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        val mp = MediaPlayer.create(context, R.raw.notification)
